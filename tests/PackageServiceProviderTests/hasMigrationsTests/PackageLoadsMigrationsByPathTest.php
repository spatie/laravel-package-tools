...
trait PackageLoadsMigrationsByPathTest
{
    public function configurePackage(Package $package)
    {
        ...
        $package
            ...
            ->loadsMigrationsByPath('../database/migrations');
    }
}

uses(PackageLoadsMigrationsByPathTest::class);
...
it("loads the non-stub migrations by path for 'artisan migrate'", function () use ($expectLoaded) {
    $this
        ->artisan('vendor:publish --tag=package-tools-migrations')
        ->assertSuccessful();
