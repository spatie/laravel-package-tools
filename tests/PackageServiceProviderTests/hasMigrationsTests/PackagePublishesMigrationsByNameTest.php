...
trait PackagePublishesMigrationsByNameTest
{
    public function configurePackage(Package $package)
    {
        ...
        $package
            ...
            ->publishesMigrationsByName('create_table_explicit_normal', 'create_table_explicit_stub')
            ->publishesMigrationsByName('folder/create_table_subfolder_explicit_stub')
            ->publishesMigrationsByName('folder/create_table_subfolder_explicit_normal');
    }
}

uses(PackagePublishesMigrationsByNameTest::class);
