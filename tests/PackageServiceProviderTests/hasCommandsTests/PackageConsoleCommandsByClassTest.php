...
trait PackageConsoleCommandsByClassTest
{
    public function configurePackage(Package $package)
    {
        $package
            ...
            ->hasRoutes('web')
            ->hasConsoleCommandsByClass(TestCommand::class)
            ->hasConsoleCommandsByClass([OtherTestCommand::class])
            ->hasConsoleCommandsByClass(ThirdTestCommand::class, FourthTestCommand::class);
    }
}

uses(PackageConsoleCommandsByClassTest::class);
