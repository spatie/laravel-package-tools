...
trait PackageLoadsConsoleCommandsByClassTest
{
    public function configurePackage(Package $package)
    {
        $package
            ...
            ->hasRoutes('web')
            ->loadsConsoleCommandsByClass(TestCommand::class)
            ->loadsConsoleCommandsByClass([OtherTestCommand::class])
            ->loadsConsoleCommandsByClass(ThirdTestCommand::class, FourthTestCommand::class);
    }
}

uses(PackageLoadsConsoleCommandsByClassTest::class);

it("can register and execute Console Commands loaded by class name", function () {
    $this
...
it("can register but NOT execute a Console Command loaded by class name as part of a web transaction", function () {
