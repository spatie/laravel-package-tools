...
trait PackageLoadsCommandsByClassTest
{
    public function configurePackage(Package $package)
    {
        $package
            ...
            ->hasRoute('web')
            ->loadsCommandsByClass(TestCommand::class)
            ->loadsCommandsByClass([OtherTestCommand::class])
            ->loadsCommandsByClass(ThirdTestCommand::class, FourthTestCommand::class);
    }
}

uses(PackageLoadsCommandsByClassTest::class);
